...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            ...
            <img src="{{ asset('images/logo.png') }}" class="" alt=""
                style="max-height: 60px; width: 70px;">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item {{ request()->is('/') ? 'active' : '' }}"><a
                            href="{{ route('frontend.welcome') }}" class="nav-link">Home</a></li>
                    <li class="nav-item {{ request()->is('front/services') ? 'active' : '' }}"><a
                            href="{{ route('frontend.services') }}" class="nav-link">Services</a></li>
                    <li class="nav-item {{ request()->is('front/quote') ? 'active' : '' }}"><a
                            href="{{ route('frontend.quote') }}" class="nav-link">Quote</a></li>
                    <li class="nav-item {{ request()->is('front/fleets') ? 'active' : '' }}"><a
                            href="{{ route('frontend.fleets') }}" class="nav-link">Fleets</a></li>
                    ...
                    <li class="nav-item {{ request()->is('front/booking') ? 'active' : '' }}"><a
                            href="{{ route('frontend.booking') }}"
                            class="nav-link btn btn-warning text-white my_booking_btn ">BOOK ONLINE</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight"
        style="background-image: url('{{ asset('images/bg_3.jpg') }}');" data-stellar-background-ratio="0.5">
                ...
                <div class="col-md-12	featured-top">
                    <div class="row no-gutters">
                        <div class="col-md-12 d-flex align-items-center shadow">
                            <form action="{{ route('user.quote') }}" method="post"
                                class="col-md-12 request-form ftco-animate bg-primary ">
                                @displayErrors
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="pickup_address"
                                        id="pickup_address" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label for="" class="label">Drop-off location</label>
                                    <input type="text" class="form-control" name="destination_address"
                                        id="destination_address" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        @foreach ($data as $fleet)
                                            <div class="col-md-4 mb-4">
                                                <div type="button" class="card fleet-card"
                                                    id="fleetCard{{ $fleet->id }}">
                                                    <img src="{{ asset('storage/' . $fleet->banner_image) }}"
                                                        class="card-img-top" alt="{{ $fleet->title }}">
                                                    <div class="card-body">
                                                        <h5 class="card-title">{{ $fleet->title }}</h5>
                                                        <p class="text-dark">Max Passengers :
                                                            {{ $fleet->max_passengers }}</p>
                                                        <p class="text-dark">Max Suitcase :
                                                            {{ $fleet->max_suitcases }}</p>
                                                        <p class="text-dark">Max Hand Luggage :
                                                            {{ $fleet->max_hand_luggage }}</p>
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2"><a href="#" class="logo">Bristol<span> Cabwise</span></a>
                        </h2>

    		...
    		<div class="row">
    			...
    			<div class="col-md-4">
                    <div class="car-wrap rounded ftco-animate">
                        <div class="img rounded d-flex align-items-end p-0">
                            <img src="{{ asset('storage/'.$item->banner_image) }}" alt="{{ $item->title }}">
                        </div>
                        <div class="text">
                            <h2 class="mb-0"><a href="car-single.html">{{ $item->title }}</a></h2>
                            <div class="d-flex mb-3">
                                <span class="cat">{{ $item->description }}</span>
                                <p class="price ml-auto">${{ $item->rate }} <span>/KM</span></p>
                            </div>
                            <p class="d-flex mb-0 d-block">
                                <a href="{{ route('frontend.booking') }}" class="btn btn-primary py-2 mr-1">Book now</a>
                                <a href="{{ route('frontend.fleets.details',$item->id) }}" class="btn btn-secondary py-2 ml-1">Details</a>
                            </p>
                        </div>
                    </div>
                </div>

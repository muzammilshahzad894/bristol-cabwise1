...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('{{ asset('storage/'.$data->banner_image) }}');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section bg-light">
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="car-wrap rounded ftco-animate">
                        <div class="img rounded d-flex align-items-end">
                            <img src="{{ asset('storage/'.$data->banner_image) }}" alt="{{ $data->title }}">
                        </div>
                        <div class="text">
                            <h2 class="mb-0"><a href="car-single.html">{{ $data->title }}</a></h2>
                            <div class="d-flex mb-3">
                                <span class="cat">{{ $data->description }}</span>
                                <p class="price ml-auto">${{ $data->rate }} <span>/KM</span></p>
                            </div>
                            <div class="mb-3">
                                <h4 class="text-center">Features</h4><hr>
                                @foreach($data->features as $feature)
                                <p class="price ml-auto">{{ $feature->feature_name }}</p>
                                @endforeach
                            </div>
                            <p class="d-flex mb-0 d-block"><a href="{{ route('frontend.booking') }}" class="btn btn-primary py-2 mr-1">Book now</a> </p>
                        </div>
                    </div>
                </div>
                @endif
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <h2 class="mb-4 text-center">Fleet Gallery</h2><hr>
                    @foreach($data->images as $image)
                    <div class="media mt-4">
                        <img src="{{ asset('storage/'.$image->url) }}" class="mr-3" alt="{{ $image->title }}">
                        <div class="media-body">
                            <h4 class="mt-0 display-4">{{ $image->title }}</h4>

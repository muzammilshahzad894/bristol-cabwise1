...
use App\Services\FleetFeatureService;
use App\Http\Requests\FleetFeatureRequest;

class FleetFeatureController extends Controller
{
    private $_service = null;
    private $_directory = 'auth/pages/fleetfeatures';
    private $_route = 'fleetfeatures';
    ...
    {
        $this->_service = new FleetFeatureService();
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(FleetFeatureRequest $request)
    {
        try {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(FleetFeatureRequest $request, $id)
    {
        try {
